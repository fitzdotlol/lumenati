...
#define PIXELFORMAT_COMPRESSED_RED_RGTC1_EXT              PIXELFORMAT_COMPRESSED_ETC1_RGB
#define PIXELFORMAT_COMPRESSED_RED_GREEN_RGTC2_EXT        PIXELFORMAT_COMPRESSED_ETC2_RGB
